        ...
        <section id="challenges" className="page">
            ...
            <section className={`challenges-container ${fadeInClass}`}>
                <article className="challenges__homepage" aria-labelledby="homepage-title">
                    ...
                    <div className="challenges__preview homepage" style={{backgroundImage: `url(${HomepagePreview})`}} role="img" aria-label="Vista previa del reto Homepage"></div>
                ...
                <article className="challenges__signup-page" aria-labelledby="signup-title">
                    ...
                    <div className="challenges__preview signup" style={{backgroundImage: `url(${SignUpPreview})`}} role="img" aria-label="Vista previa del reto Crear Cuenta"></div>
                ...
                <article className="challenges__checkout" aria-labelledby="checkout-title">
                    ...
                    <div className="challenges__preview checkout" style={{backgroundImage: `url(${CheckoutPreview})`}} role="img" aria-label="Vista previa del reto Checkout"></div>
                ...
                <article className="challenges__calculator" aria-labelledby="calculator-title">
                    ...
                    <div className="challenges__preview calculator" style={{backgroundImage: `url(${CalculatorPreview})`}} role="img" aria-label="Vista previa del reto Calculadora"></div>
