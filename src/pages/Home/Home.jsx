    ...
    return (
        <div id="home" className="page">
            ...
            <section className={`projects-container ${fadeInClass}`}>
                ...
                <Card image={ ComingSoonImage } title="Sistema de Componentes" description="En mi última empresa trabajé como desarrolladora web en un proyecto de creación de un nuevo sistema de componentes y portales. Colaboré estrechamente con el equipo de diseño UX/UI, proporcionando feedback y resolviendo dudas. Una vez creado el sistema, diseñé en ocasiones componentes adicionales y algunas páginas web, además validé los nuevos componentes y diseños web propuestos por los diseñadores." link="" additionalClass="comingsoon"  />
